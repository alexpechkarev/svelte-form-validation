...
<style>
	.success input {
		...
		box-shadow: var(--tw-ring-inset) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--color-success);
		color: var(--color-success);
	}

	.warning input {
		/* border: 1px solid var(--color-warning); */
		box-shadow: var(--tw-ring-inset) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--color-warning);
		color: var(--color-warning);
	}

	.error input {
		/* border: 1px solid var(--color-error); */
		box-shadow: var(--tw-ring-inset) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--color-error);
